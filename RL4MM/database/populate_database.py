...
def populate_database(
    ...
    exchange: str = "NASDAQ",
    path_to_lobster_data: Optional[str] = None,  # This
):
    if tickers is None:
        tickers = ["AMZN"]
    ...
    for ticker in tickers:
        for trading_date in trading_dates:
            ...
            book_iterator = read_csv(book_path, header=None, names=book_cols, iterator=True, chunksize=10000)
            message_iterator = read_csv(
                message_path,
                header=None,
                names=message_cols,
                usecols=[0, 1, 2, 3, 4, 5],
            ...
            for messages in tqdm(message_iterator):
                books = next(book_iterator)
