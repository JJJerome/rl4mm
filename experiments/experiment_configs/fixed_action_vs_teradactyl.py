...
default_alpha = 2
default_beta = 5
default_omega = Teradactyl.calculate_omega(default_alpha, default_beta)
default_kappa = Teradactyl.calculate_kappa(default_alpha, default_beta)
...
for default_kappa in [7,20]:
    for default_omega in [0.2,0.4]:
        for max_kappa in [40, 100]:
            agents.append(Teradactyl(max_inventory, default_kappa, default_omega, max_kappa))
